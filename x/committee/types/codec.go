...
func init() {
	...
	// RegisterProposalTypeCodec(communitytypes.CommunityCDPRepayDebtProposal{}, "0gchain/CommunityCDPRepayDebtProposal")
	// RegisterProposalTypeCodec(communitytypes.CommunityCDPWithdrawCollateralProposal{}, "0gchain/CommunityCDPWithdrawCollateralProposal")
	// RegisterProposalTypeCodec(communitytypes.CommunityPoolLendWithdrawProposal{}, "0gchain/CommunityPoolLendWithdrawProposal")
	// RegisterProposalTypeCodec(kavadisttypes.CommunityPoolMultiSpendProposal{}, "0gchain/CommunityPoolMultiSpendProposal")
}
