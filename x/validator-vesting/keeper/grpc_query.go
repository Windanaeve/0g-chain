...
// CirculatingSupply implements the gRPC service handler for querying the circulating supply of the a0gi token.
...
func (s queryServer) CirculatingSupplySWP(c context.Context, req *types.QueryCirculatingSupplySWPRequest) (*types.QueryCirculatingSupplySWPResponse, error) {
	...
	// []{Ecosystem, Team, Treasury, 0g-chain Stakers, LP Incentives}
